...
export default function EditClientPage() {
  ...
  // State form data (company dihilangkan)
  const [formData, setFormData] = useState({
    name: "Tony Stark",
    email: "tony@stark.com",
    phone: "0898-7654-3210",
    address: "Stark Tower Ballroom, Lt. 88, Jakarta Pusat",
  });
  ...
  const t = {
    id: {
      ...
      subtitle:
        "Pastikan data profil dan kontak klien sudah sesuai dengan dokumen terbaru.",
    ...
    en: {
      ...
      subtitle:
        "Ensure client profile and contact data matches the latest documents.",
    ...
    <div className="max-w-3xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
      ...
      >
        <div className="p-8 space-y-6">
          {/* Baris 1: Nama Klien (Sekarang full width karena instansi dihilangkan) */}
      ...
      {/* Info Tambahan di Bawah (ID Klien Dihilangkan) */}
